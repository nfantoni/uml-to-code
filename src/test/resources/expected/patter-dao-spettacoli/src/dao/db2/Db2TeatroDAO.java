...
public class Db2TeatroDAO implements TeatroDAO {
        ...
        static String create = "CREATE TABLE TEATRO ( NOME VARCHAR(255) NOT NULL PRIMARY KEY , INDIRIZZO VARCHAR(255) , CAPIENZA INT )";
    ...
    public TeatroDTO read(String nome) {
        ...
        if (nome == null) {
            System.out
            .println("read(): cannot read an entry with a negative nome");
            return result;
        }
        Connection conn = Db2DAOFactory.createConnection();
        try {
    ...
    public boolean update(TeatroDTO teatro) {
        ...
        try {
            ...
            prep_stmt.clearParameters();
                ...
                prep_stmt.setString(2, teatro.getIndirizzo());
                prep_stmt.setInt(3, teatro.getCapienza());
                prep_stmt.setString(4, teatro.getNome());
    ...
    public boolean delete(String nome) {
        ...
        if (nome == null) {
            System.out
            .println("delete(): cannot delete an entry with an invalid nome ");
            return result;
        }
        Connection conn = Db2DAOFactory.createConnection();
        try {
