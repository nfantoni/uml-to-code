...
public class DAOTest {
	...
	public static void main(String[] args) {
		...
		builder.append("Il nome del teatro in cui si sono tenuti pi� spettacoli di genere balletto �: "
				+ getNome(teatroDAO));

		List<String> generi = getGeneri(spettacoloDAO);

		builder.append("\n\nL�elenco distinto dei generi presenti nella programmazione teatrale �:");
